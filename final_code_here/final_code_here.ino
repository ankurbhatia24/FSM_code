 ...
 * Theme: Ant Bot
 * Functions:setup, loop, millis_servo(int), increase(servo, int, int, int), decrease(servo, int, int, int)
 * Global Variables: curr_node, supply_taken, 
...
int SIM[4] = {
  0, 0, 0, 0}/*{6, 33, 208, 99}  /*{131, 32, 197, 96 } */
,id_rx[4];
